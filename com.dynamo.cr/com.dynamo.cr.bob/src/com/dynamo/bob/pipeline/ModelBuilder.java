...
public class ModelBuilder extends ProtoBuilder<ModelDesc.Builder> {
    ...
    public void build(Task task) throws CompileExceptionError, IOException {
        ...
        rigBuilder.setMeshSet(ResourceUtil.replaceExt(modelDescBuilder.getMesh(), ".meshsetc"));
        if(!modelDescBuilder.getSkeleton().isEmpty()) {
            rigBuilder.setSkeleton(ResourceUtil.replaceExt(modelDescBuilder.getSkeleton(), ".skeletonc"));
        }
        ...
        if (modelDescBuilder.getAnimations().equals("")) {
            ...
            rigBuilder.setAnimationSet(ResourceUtil.replaceExt(modelDescBuilder.getAnimations(), ".animationsetc"));
        }
            ...
            rigBuilder.setAnimationSet(ResourceUtil.replaceExt(modelDescBuilder.getAnimations(), "_generated_0.animationsetc"));
        } else {
