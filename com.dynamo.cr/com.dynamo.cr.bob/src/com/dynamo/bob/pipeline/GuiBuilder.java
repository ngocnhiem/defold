...
public class GuiBuilder extends ProtoBuilder<SceneDesc.Builder> {
    ...
    public static SceneDesc.Builder transformScene(GuiBuilder builder, String input, SceneDesc.Builder sceneBuilder, ISceneBuilderIO sceneIO, HashMap<String, SceneDesc.Builder> sceneResourceCache, boolean flattenTemplates) throws IOException, CompileExceptionError {
        ...
        if(builder != null) {
            ...
            sceneBuilder.setScript(ResourceUtil.replaceExt(scriptPath, ".gui_script", ".gui_scriptc"));
            sceneBuilder.setMaterial(ResourceUtil.replaceExt(sceneBuilder.getMaterial(), ".material", ".materialc"));
            ...
            for (FontDesc f : sceneBuilder.getFontsList()) {
                ...
                newFontList.add(FontDesc.newBuilder().mergeFrom(f).setFont(ResourceUtil.replaceExt(f.getFont(), ".font", ".fontc")).build());
            }
            ...
            for (SpineSceneDesc f : sceneBuilder.getSpineScenesList()) {
                ...
                ResourceDesc desc = ResourceDesc.newBuilder().setName(f.getName()).setPath(ResourceUtil.replaceExt(f.getSpineScene(), ".spinescene", ".spinescenec")).build();
            ...
            for (ParticleFXDesc f : sceneBuilder.getParticlefxsList()) {
                ...
                newParticleFXList.add(ParticleFXDesc.newBuilder().mergeFrom(f).setParticlefx(ResourceUtil.replaceExt(f.getParticlefx(), ".particlefx", ".particlefxc")).build());
            }
            ...
            for (MaterialDesc f : sceneBuilder.getMaterialsList()) {
                ...
                newMaterialList.add(MaterialDesc.newBuilder().mergeFrom(f).setMaterial(ResourceUtil.replaceExt(f.getMaterial(), ".material", ".materialc")).build());
            }
            ...
            for (ResourceDesc f : sceneBuilder.getResourcesList()) {
                ...
                resourceNames.add(f.getName());
                newResourcesList.add(ResourceDesc.newBuilder().mergeFrom(f).setPath(ResourceUtil.replaceExt(f.getPath(), ".spinescene", ".spinescenec")).build());
            }
